...
Реализована серверная часть на Express и TypeScript.
...
* отзывы покупателей;
* аналитика по продажам, остаткам и конверсии;
* AI-рекомендации и mock-ответы;
* проверка состояния API и базы данных.

Для работы с базой используется PostgreSQL и Prisma.

### Frontend

Реализован интерфейс на React, TypeScript и Vite.
...
* отчёт после синхронизации;
* аналитика по товарам.

## Умные функции SellerHUB

В проект добавлены функции, которые помогают продавцу быстрее находить проблемы:
...
* Executive Summary на Dashboard.

Эти функции работают на основе данных о товарах, остатках, рейтинге, отзывах и продажах.
...
Backend содержит API, бизнес-логику, работу с базой данных и тесты.

Frontend содержит страницы, компоненты, стили и работу с API.

## Что можно улучшить дальше

В дальнейшем можно добавить:

* реальные API-интеграции с маркетплейсами;
* настоящую AI-интеграцию через API-ключ;
* роли пользователей;
* расширенные отчёты;
* экспорт аналитики в файл;
* больше автоматических рекомендаций.
